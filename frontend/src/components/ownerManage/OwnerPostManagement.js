            ...
            if (response?.data) {
                ...
                const formattedRooms = rawRooms.map(room => {
                    ...
                    return {
                        ...
                        address: {
                            address_name: room.address_name || room.address?.address_name,
                            city_name: room.city_name || room.address?.city_name,
                            district_name: room.district_name || room.address?.district_name,
                            latitude: room.latitude || room.address?.latitude,
                            longitude: room.longitude || room.address?.longitude,
