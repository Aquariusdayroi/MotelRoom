        ...
        <div className="container d-flex align-items-center justify-content-center">
            <div className="profile-box text-center">
                ...
                <div className="content">
                    ...
                    <div style={{ fontStyle: "italic" }}>69 lượt đăng bài</div>
                    <div style={{ fontStyle: "italic" }}>69 lượt đánh giá</div>
                </div>
                <div className="contact">
                    <h5 style={{ fontWeight: 600 }}>Thông tin liên hệ</h5>
                    <div className="contact-customer">
                        <div>Số điện thoại: 0955696969</div>
                        <div>Email: endervaigay@gmail.com</div>
                    </div>
                </div>
