...
import ProfileMenu from "../components/model/ProfileMenu";
...
function Profile() {
    ...
    const reviews = [
        {
            ...
            date: "2025-08-16",
            time: "01:11",
            content: "Trọ như cức, chủ trọ như cức, làm ăn gian dối. Sớm trả nghiệp, nhắm giữ được cọc thì giữ...",
            location: "........."
        },
        {
            rating: 1,
    ...
    return (
        <div>
            ...
            <div className={styles.profileContainer}>
                <div className={styles.profileContent}>
                    ...
                    <div className="p-3 rounded mt-3">
                        ...
                        <p style={{ whiteSpace: 'pre-wrap', fontSize: '14px', lineHeight: '1.6', marginBottom: '1rem', height: '100%' }}>
                            Phần{"\n"}này{"\n"}tự{"\n"}mô{"\n"}tả{"\n"}bản{"\n"}thân
                        </p>
                        <div className="d-flex gap-2">
                            <button className="btn btn-info text-white">Nhắn tin</button>
                            <button className="btn btn-danger">Báo cáo</button>
                        </div>
                    </div>
                </div>
                <div className={styles.rentalSection}>
                    <div className="d-flex align-items-center justify-content-between mb-3 px-3" style={{ gap: '1rem' }}>
            ...
            <div className="d-flex align-items-center" style={{ padding: '0 2%' }}>
